...
|----------------------------------|---------------|-------------------------------------------|-----------------------------|----------------------------------------|-------------------------------------------------------------|
|Allsec LILO *Important*           | $${\color{Azure3}Local \space Machine}$$ | Google Chrome                             |  30secs/1min                | $${\color{green}Low}$$                 | [`Link`](https://www.allsechro.ph/OP360/Common/HomePage.aspx) |
